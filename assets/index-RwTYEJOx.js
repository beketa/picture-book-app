 ...
 */const Ge=Symbol("node");var hn;(r=>{var t,e,n,o;class a{constructor(u,c={}){Kr(this,e),pa(this,t);const h=wf(u)[vo];if(this[Ge]=h,h.wrapper=this,c){const f=c.equals;f&&(h.equal=f),h.watched=c[r.subtle.watched],h.unwatched=c[r.subtle.unwatched]}}get(){if(!(0,r.isState)(this))throw new TypeError("Wrong receiver type for Signal.State.prototype.get");return _f.call(this[Ge])}set(u){if(!(0,r.isState)(this))throw new TypeError("Wrong receiver type for Signal.State.prototype.set");if(cf())throw new Error("Writes to signals not permitted during Watcher callback");const c=this[Ge];Cf(c,u)}}t=Ge,e=new WeakSet,r.isState=s=>typeof s=="object"&&da(e,s),r.State=a;class i{constructor(u,c){Kr(this,o),pa(this,n);const h=mf(u)[vo];if(h.consumerAllowSignalWrites=!0,this[Ge]=h,h.wrapper=this,c){const f=c.equals;f&&(h.equal=f),h.watched=c[r.subtle.watched],h.unwatched=c[r.subtle.unwatched]}}get(){if(!(0,r.isComputed)(this))throw new TypeError("Wrong receiver type for Signal.Computed.prototype.get");return ic(this[Ge])}}n=Ge,o=new WeakSet,r.isComputed=s=>typeof s=="object"&&da(o,s),r.Computed=i,(s=>{var u,c,l,h;function f(x){let y,b=null;try{b=Yn(null),y=x()}finally{Yn(b)}return y}s.untrack=f;function p(x){var y;if(!(0,r.isComputed)(x)&&!(0,r.isWatcher)(x))throw new TypeError("Called introspectSources without a Computed or Watcher argument");return((y=x[Ge].producerNode)==null?void 0:y.map(b=>b.wrapper))??[]}s.introspectSources=p;function d(x){var y;if(!(0,r.isComputed)(x)&&!(0,r.isState)(x))throw new TypeError("Called introspectSinks without a Signal argument");return((y=x[Ge].liveConsumerNode)==null?void 0:y.map(b=>b.wrapper))??[]}s.introspectSinks=d;function m(x){if(!(0,r.isComputed)(x)&&!(0,r.isState)(x))throw new TypeError("Called hasSinks without a Signal argument");const y=x[Ge].liveConsumerNode;return y?y.length>0:!1}s.hasSinks=m;function v(x){if(!(0,r.isComputed)(x)&&!(0,r.isWatcher)(x))throw new TypeError("Called hasSources without a Computed or Watcher argument");const y=x[Ge].producerNode;return y?y.length>0:!1}s.hasSources=v;class g{constructor(y){Kr(this,c),Kr(this,l),pa(this,u);let b=Object.create(Ri);b.wrapper=this,b.consumerMarkedDirty=y,b.consumerIsAlwaysLive=!0,b.consumerAllowSignalWrites=!1,b.producerNode=[],this[Ge]=b}watch(...y){if(!(0,r.isWatcher)(this))throw new TypeError("Called unwatch without Watcher receiver");Gs(this,l,h).call(this,y);const b=this[Ge];b.dirty=!1;const _=Yn(b);for(const k of y)Uo(k[Ge]);Yn(_)}unwatch(...y){if(!(0,r.isWatcher)(this))throw new TypeError("Called unwatch without Watcher receiver");Gs(this,l,h).call(this,y);const b=this[Ge];sr(b);for(let _=b.producerNode.length-1;_>=0;_--)if(y.includes(b.producerNode[_].wrapper)){zo(b.producerNode[_],b.producerIndexOfThis[_]);const k=b.producerNode.length-1;if(b.producerNode[_]=b.producerNode[k],b.producerIndexOfThis[_]=b.producerIndexOfThis[k],b.producerNode.length--,b.producerIndexOfThis.length--,b.nextProducerIndex--,_<b.producerNode.length){const S=b.producerIndexOfThis[_],R=b.producerNode[_];Ii(R),R.liveConsumerIndexOfThis[S]=_}}}getPending(){if(!(0,r.isWatcher)(this))throw new TypeError("Called getPending without Watcher receiver");return this[Ge].producerNode.filter(b=>b.dirty).map(b=>b.wrapper)}}u=Ge,c=new WeakSet,l=new WeakSet,h=function(x){for(const y of x)if(!(0,r.isComputed)(y)&&!(0,r.isState)(y))throw new TypeError("Called watch/unwatch without a Computed or State argument")},r.isWatcher=x=>da(c,x),s.Watcher=g;function w(){var x;return(x=uf())==null?void 0:x.wrapper}s.currentComputed=w,s.watched=Symbol("watched"),s.unwatched=Symbol("unwatched")})(r.subtle||(r.subtle={}))})(hn||(hn={}));/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const If=Symbol("SignalWatcherBrand"),Sf=new FinalizationRegistry(({watcher:r,signal:t})=>{r.unwatch(t)}),Hs=new WeakMap;function kf(r){return r[If]===!0?(console.warn("SignalWatcher should not be applied to the same class more than once."),r):class extends r{constructor(){super(...arguments),this._$St=new hn.State(0),this._$Si=!1,this._$So=!0,this._$Sh=new Set}_$Sl(){if(this._$Su!==void 0)return;this._$Sv=new hn.Computed(()=>{this._$St.get(),super.performUpdate()});const t=this._$Su=new hn.subtle.Watcher(function(){const e=Hs.get(this);e!==void 0&&(e._$Si===!1&&e.requestUpdate(),this.watch())});Hs.set(t,this),Sf.register(this,{watcher:t,signal:this._$Sv}),t.watch(this._$Sv)}_$Sp(){this._$Su!==void 0&&(this._$Su.unwatch(this._$Sv),this._$Sv=void 0,this._$Su=void 0)}performUpdate(){this.isUpdatePending&&(this._$Sl(),this._$Si=!0,this._$St.set(this._$St.get()+1),this._$Si=!1,this._$Sv.get())}update(t){try{this._$So?(this._$So=!1,super.update(t)):this._$Sh.forEach(e=>e.commit())}finally{this.isUpdatePending=!1,this._$Sh.clear()}}requestUpdate(t,e,n){this._$So=!0,super.requestUpdate(t,e,n)}connectedCallback(){super.connectedCallback(),this.requestUpdate()}disconnectedCallback(){super.disconnectedCallback(),queueMicrotask(()=>{this.isConnected===!1&&this._$Sp()})}_(t){this._$Sh.add(t);const e=this._$So;this.requestUpdate(),this._$So=e}m(t){this._$Sh.delete(t)}}}/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,$t=function(r,t,e,n){n===void 0&&(n=!1),this.variableNames=["A","B"],this.supportsBroadcasting=!0,this.packedInputs=!0,this.packedOutput=!0,this.outputShape=le(t,e);var o=this.outputShape.length,a="";if(n)if(o===0||Y(this.outputShape)===1)a=`
  ...
  `}(t,r[r.length-1],r[r.length-2],e),i=function(s,u){var c=s.length,l=function(h,f){for(var p=[],d=0;d<=1;d++)for(var m=0;m<=1;m++){for(var v=(d===0?"r":"rp1")+", "+(m===0?"c":"cp1"),g=2;g<h;g++)v=f[f.length-1-g]+","+v;p.push(v)}return p}(c,u);return c===1?`getA(rc),
    ...
    `},Gv=function(r,t,e,n){this.variableNames=["A"],this.outputShape=[];var o=r[0],a=r[1],i=r[2],s=r[3];this.outputShape=[o,t,e,s];var u=[n&&t>1?a-1:a,n&&e>1?i-1:i],c=[n&&t>1?t-1:t,n&&e>1?e-1:e],l=n?"0.5":"0.0";this.userCode=`
      const vec2 effectiveInputOverOutputRatioRC = vec2(
          `+u[0]/c[0]+`,
          `+u[1]/c[1]+`);
      const vec2 inputShapeRC = vec2(`+a+".0, "+i+`.0);
