 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Wf;function zf(r){return(t,e)=>Nc(t,e,{get(){return(this.renderRoot??Wf??(Wf=document.createDocumentFragment())).querySelectorAll(r)}})}var Uf=Object.defineProperty,$f=(r,t,e)=>t in r?Uf(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e,$a=(r,t,e)=>($f(r,typeof t!="symbol"?t+"":t,e),e),Vf=(r,t,e)=>{if(!t.has(r))throw TypeError("Cannot "+e)},Va=(r,t)=>{if(Object(t)!==t)throw TypeError('Cannot use the "in" operator on this value');return r.has(t)},wo=(r,t,e)=>{if(t.has(r))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(r):t.set(r,e)},_u=(r,t,e)=>(Vf(r,t,"access private method"),e);/**
 * @license
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function rd(r){const t=Object.create(id);t.value=r;const e=()=>(fa(t),t.value);return e[Uo]=t,e}function od(){return fa(this),this.value}function ad(r,t){qf()||nd(),r.equal.call(r.wrapper,r.value,t)||(r.value=t,sd(r))}const id={...es,equal:Pc,value:void 0};function sd(r){r.version++,jf(),Fc(r)}/**
 * @license
...
`,Jt=function(r,t,e,n){n===void 0&&(n=!1),this.variableNames=["A","B"],this.supportsBroadcasting=!0,this.packedInputs=!0,this.packedOutput=!0,this.outputShape=fe(t,e);var o=this.outputShape.length,a="";if(n)if(o===0||Y(this.outputShape)===1)a=`
    ...
    `},Pv=function(r){this.variableNames=["A"],this.packedInputs=!0,this.packedOutput=!0,this.outPackingScheme=Zr.DENSE;var t=Ur(r),e=et();this.outputShape=r,this.userCode=`
      ivec3 outCoordsFromFlatIndex(int index) {
        `+Ln(["r","c","d"],r)+`
        return ivec3(r, c, d);
      }
...
`),new ye(0,0)).draw(this.canvasBuffer)}t.drawImage(this.canvasBuffer,0,0,this.canvasBuffer.width,this.canvasBuffer.height)}}async detectFaces(){const r=this.detectionBuffer.getContext("2d",{alpha:!1,willReadFrequently:!0});if(!r){setTimeout(()=>this.detectFaces(),100);return}r.drawImage(this.video,0,0,this.detectionBuffer.width,this.detectionBuffer.height),this.detections=await Ox(this.detectionBuffer,new Yh).withAgeAndGender(),this.firstDetected||(console.log("First detected"),this.firstDetected=!0);const t={numFaces:this.detections.length,faces:this.detections.map(e=>({age:e.age}))};Lc.set(t),this.frameTimes.push(Date.now()),this.frameTimes.length>6&&this.frameTimes.shift(),this.frameTimes.length==6&&(this.frameRate=5e3/(this.frameTimes[5]-this.frameTimes[0])),setTimeout(()=>this.detectFaces(),100)}async startRecording(){try{const t=await(await navigator.storage.getDirectory()).getFileHandle("test.mp4",{create:!0});this.writableStream=await t.createWritable()}catch(r){console.log("Open file failed: ",r);return}if(this.canvas){const r=this.canvas.captureStream(30);this.mediaRecorder=new MediaRecorder(r,{mimeType:"video/mp4;codecs=avc1"}),this.mediaRecorder.ondataavailable=t=>{t.data.size>0&&this.writableStream&&this.writableStream.write(t.data)},this.mediaRecorder.onstop=async()=>{this.writableStream&&(await this.writableStream.close(),this.writableStream=null,console.log("File saved successfully"))},this.mediaRecorder.start(1e3),console.log("Recording started")}}stopRecording(){this.mediaRecorder&&(this.mediaRecorder.stop(),console.log("Recording stopped"))}async exportRecording(){try{const e=await(await(await navigator.storage.getDirectory()).getFileHandle("test.mp4")).getFile(),n=URL.createObjectURL(e),o=document.createElement("a");o.download="test.mp4",o.href=n,o.style.display="none",document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(n)}catch(r){console.log("OPFS Read Error:",r)}}render(){return ce`
  ...
  `;Ta([io({type:String})],En.prototype,"translateX",2);Ta([io({type:String})],En.prototype,"translateY",2);Ta([io({type:String})],En.prototype,"rotate",2);En=Ta([ke("giant-turnip-actor")],En);var c1=Object.getOwnPropertyDescriptor,l1=Object.getPrototypeOf,h1=Reflect.get,f1=(r,t,e,n)=>{for(var o=n>1?void 0:n?c1(t,e):t,a=r.length-1,i;a>=0;a--)(i=r[a])&&(o=i(o)||o);return o},d1=(r,t,e)=>h1(l1(r),e,t);let Gr=class extends Pe{render(){return ce`
      <div id="container">
  ...
  `;Na([ae("img#left-hand")],kn.prototype,"leftHand",2);Na([ae("img#right-hand")],kn.prototype,"rightHand",2);Na([ae("img#eyebrows")],kn.prototype,"eyebrows",2);kn=Na([ke("old-man-pulling-actor")],kn);var G1=Object.getOwnPropertyDescriptor,H1=Object.getPrototypeOf,j1=Reflect.get,q1=(r,t,e,n)=>{for(var o=n>1?void 0:n?G1(t,e):t,a=r.length-1,i;a>=0;a--)(i=r[a])&&(o=i(o)||o);return o},K1=(r,t,e)=>j1(H1(r),e,t);let Hr=class extends Pe{render(){return ce`
      <div id="container">
  ...
  `;hf([ae("img#hand")],Cr.prototype,"hand",2);Cr=hf([ke("old-man-watering-actor")],Cr);var aw=Object.getOwnPropertyDescriptor,iw=Object.getPrototypeOf,sw=Reflect.get,uw=(r,t,e,n)=>{for(var o=n>1?void 0:n?aw(t,e):t,a=r.length-1,i;a>=0;a--)(i=r[a])&&(o=i(o)||o);return o},cw=(r,t,e)=>sw(iw(r),e,t);let jr=class extends Pe{render(){return ce`
      <div id="container">
  ...
  `;jr=uw([ke("old-man-actor")],jr);var lw=Object.getOwnPropertyDescriptor,hw=Object.getPrototypeOf,fw=Reflect.get,dw=(r,t,e,n)=>{for(var o=n>1?void 0:n?lw(t,e):t,a=r.length-1,i;a>=0;a--)(i=r[a])&&(o=i(o)||o);return o},pw=(r,t,e)=>fw(hw(r),e,t);let qr=class extends Pe{render(){return ce`
      <div id="container">
  ...
  `;qi=ff([ke("sample-book")],qi);var Ew=Object.getOwnPropertyDescriptor,kw=(r,t,e,n)=>{for(var o=n>1?void 0:n?Ew(t,e):t,a=r.length-1,i;a>=0;a--)(i=r[a])&&(o=i(o)||o);return o};let Ki=class extends ao{constructor(){super(...arguments),this.pages=[ce`
  ...
  `;Tn([ae("select#num_faces")],Vt.prototype,"numFacesSelect",2);Tn([ae("button#recording")],Vt.prototype,"recordingToggle",2);Tn([ae("button#export")],Vt.prototype,"exportButton",2);Tn([ae("button#toggle_camera")],Vt.prototype,"cameraToggle",2);Tn([ae("face-detector")],Vt.prototype,"faceDetector",2);Tn([ae("book-viewer")],Vt.prototype,"bookViewer",2);Tn([io({type:Boolean})],Vt.prototype,"isRecording",2);Vt=Tn([ke("main-element")],Vt)});export default Pw();
